...
## Step 2: Block pairing in DiffContext
...
## Step 4: Inline structure comparison
...
## Down mode rendering (deferred)

> Deferred until Up mode word-level diffs are working and validated.
