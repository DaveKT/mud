...
> mode. Unit tests pass. Verified with `Doc/Examples/alerts-and-asides.md`.
...
Test document: `Doc/Examples/alerts-and-asides.md` — covers all five GFM types,
inline content on the tag line, rich content (bold, code, links, code blocks,
lists), all 24 DocC aside kinds, and plain blockquotes that must not trigger
alert styling.
